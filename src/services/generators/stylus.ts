 ...
 * =========================*/\n`;
  ...
  &:hover, &:focus
    ...
    if (${contrast} < 4.5)
      ...
      color ${defaultAccent}
    // Gradient text is opt-in via .cp-gradient-text; keep solid here
  &:active, &.active
    color $bi-accent1
...
`;
    ...
    stylus += `/* INPUTS - Transparent by default, subtle on focus */\n`;
  ...
  stylus += `
.copy-code, .code-toolbar, .copy-button, button[class*="copy"], textarea.copyable, .clipboard, .copy-to-clipboard, .copy-snippet
  background-color transparent
  border none
  color $text

.ql-editor, .textarea.new-input-ui, .new-input-ui, .textarea, .new-input-ui .ql-editor
  background-color transparent
  border none
  color $text
  box-shadow none
...
`;
  ...
  stylus += `\n/* INPUTS - Transparent by default, subtle on focus */\n`;
  stylus += `input, textarea, select, input[type="text"], input[type="search"], input[type="email"], input[type="password"], input[type="url"], input[type="tel"], input[type="number"]\n  background-color transparent\n  color $text\n  border-color $overlay0\n  caret-color $mauve\n  &::placeholder\n    color $subtext0\n    opacity .75\n  &:hover\n    border-color $overlay0\n    box-shadow none\n    background-color transparent\n  &:focus\n    border-color $overlay1\n    outline 2px solid rgba($mauve, .35)\n    outline-offset 2px\n    box-shadow 0 0 0 2px rgba($mauve, .2)\n    background-color fade($surface0, $tint_input_hover)\n`;
  ...
  // Layout-safety overrides: ensure color-only changes (no layout-affecting borders/shadows)
  stylus += `\n/* Layout-safety overrides (no layout changes) */\n`;
