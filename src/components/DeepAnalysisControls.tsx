    ...
    <div className="space-y-4">
        ...
        >
          ...
          <div className="flex-1">
            <div className="flex items-center gap-2">
              <Sparkles
                className="w-5 h-5 text-ctp-accent"
                aria-hidden="true"
              />
            ...
            <p className="text-sm text-ctp-subtext0 mt-1">
              AI-powered site-specific theme generation with SiteSignature
              system
            </p>
          </div>
        </label>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
            ...
            <div className="space-y-2">
              ...
              <select
                value={flavor}
                onChange={(e) =>
                  onFlavorChange(e.target.value as CatppuccinFlavor)
                }
                disabled={disabled}
      ...
      {enabled && (
        <div className="p-3 bg-ctp-accent/10 border border-ctp-accent/20 rounded-lg">
          <p className="text-xs text-ctp-subtext0">
            💡 <strong>SiteSignature System</strong> ensures each website gets a
            unique theme based on its color profile. Themes support dynamic
            flavor/accent switching – one theme, 56 combinations!
          </p>
        </div>
      )}
    </div>
